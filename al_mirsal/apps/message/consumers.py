"""Consumers for al_mirsal.apps.messages"""
...
from al_mirsal.apps.message.serializers import MessageSerializer
from al_mirsal.apps.users.models import User
...
class MessageConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def connect(self) -> None:
        ...
        # Groups
        self.channel_id = f"chat_{self.object.pk}"
        # self.groups = [self.channel_id]
    ...
    async def disconnect(self, code):
        return self.channel_layer.group_discard(self.channel_id, self.channel_name)
    ...
    async def check_authorization(self) -> bool:
        ...
        raise NotImplementedError(
            f"check_authorization is not implemented for {__name__}"
        )
